export const v3 = {
    "productName": "Photo Shotlist Maker",
    "productTier": "release",
    ...
    "capabilities": [
        "Domain-specific workbench: Content Shoot Planner",
        "Operational table: Shot list",
    ...
    "releaseChecklist": [
        ...
        "Shot Coverage reaches production threshold",
        "Consent Coverage is documented with evidence",
        "Production Readiness has no unresolved blocker",
        "Industry shotlist verified",
        "Prop checklist verified",
        "File naming plan verified"
    ],
    "operations": [
