    ...
    "criteria": [
        {
            ...
            "prompt": "Implement and verify industry shotlists with evidence that a Volta student pod, mentor, and owner can understand."
        },
        {
            ...
            "weight": 15,
            "defaultStatus": "not-started",
            "prompt": "Implement and verify lighting and framing tips with evidence that a Volta student pod, mentor, and owner can understand."
        },
        {
            "id": "consent-notes",
            "label": "Consent notes",
            "weight": 15,
            "defaultStatus": "not-started",
            "prompt": "Implement and verify consent notes with evidence that a Volta student pod, mentor, and owner can understand."
        },
        {
            ...
            "weight": 15,
            "defaultStatus": "not-started",
            "prompt": "Implement and verify asset naming system with evidence that a Volta student pod, mentor, and owner can understand."
        },
        {
            "id": "evidence-quality",
