...
**Marketing & Content** · **Repo 26/50** · **No backend. No login. Client data stays local.**

[Live app](https://volta-npo.github.io/26-photo-shotlist-maker/) · [Report an issue](https://github.com/volta-npo/26-photo-shotlist-maker/issues) · [Volta](https://voltanpo.org)
...
**Photo Shotlist Maker** is a polished, local-first open-source tool from Volta's 50-project OSS division. It helps Students coordinating content shoots on a budget turn real community work into structured evidence, client-safe handoffs, and mentor-reviewable release packets.
...
```bash
git clone https://github.com/volta-npo/26-photo-shotlist-maker.git
